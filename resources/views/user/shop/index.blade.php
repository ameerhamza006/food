...
@section('content')
 <!-- Content Wrapper Starts -->
    <div class="row" style="margin-bottom:30px;">
        <div class="col-sm-12">
         <div id="myCarousel" class="carousel slide" data-ride="carousel" style="max-height:400;width:100%;">
        <!-- Indicators -->
 
  <!-- Wrapper for slides -->
  <div class="carousel-inner" style="max-height:400;width:100%;">
      <?php $i=1; ?>
     @forelse($BannerImage as $Shop)
        <?php 
            ...
            {
                ?>
                 <div class="item active" style="max-height:380;width:100%;">
                      <!-- Intro Box Starts -->
                            @if($Shop->status == 'active')
                                    ...
                                    @endif
                                    <img src="{{$Shop->url}}" style="max-height:380px;width:100%;" alt="Chicago">
                                    @if($Shop->shopstatus=='CLOSED')
                                    <div class="carousel-caption">
                                        <h3>Closed</h3>
                                        <p>({{$Shop->shopopenstatus}})</p>
                                    </div>
                                    @endif
                            </a>
                            @endif
                ...
                ?>
                 <div class="item" style="max-height:380;width:100%;">
                       <!-- Intro Box Starts -->
                            @if($Shop->status == 'active')
                                    @if($Shop->shopstatus=='OPEN')
                                    <a href="{{url('/restaurant/details')}}?name={{$Shop->shop->name}}" class="intro-box">
    ...
    <a href="" class="intro-box">
         <div class="item active">
            <img src="{{ asset('assets/user/img/banner-2.jpg')}}" alt="Chicago">
      <div class="carousel-caption">
        <h3>Duumt</h3>
