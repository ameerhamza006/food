    ...
    {   
        try{
           ...
           /* if($request->has('longitude')){*/
            ...
            if(isset($request->latitude) && isset($request->latitude))
            {
            ...
            if($request->ajax()){
                $controller = new ShopResource;
                $Shops->map(function ($Shop) use($controller) {
                    $Shop['shopstatus'] = $controller->shoptime($Shop);
                    $Shop['shopopenstatus'] = $controller->shoptiming($Shop);
                    return $Shop;
                });
